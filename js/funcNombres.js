...
*/
//Función randomica para las notas y nombres
function randomica() {
...
//Función para obtener los resultados de la nota
...
let nombrecompleto = [];
//Colocación de manera automática para los nombres completos
for (let i = 0; i < 10; i++) {
    ...
    nombrecompleto.push(nombreCompletoAleatorio);
}
...
for (let i = 0; i < nombrecompleto.length; i++) {
    nombrescompletos.push({ nombre: nombrecompleto[i], nota: 0 });
}
